...
import 'domain/usecases/cart_usecase/update_cartItem_usecase.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => UpdateOrderStatusUseCase(sl<OrderRepository>()));
  ...
  sl.registerFactory(() => OrderBloc(addOrderUseCase: sl(), getOrdersUseCase: sl(), updateOrderStatusUseCase: sl(),));
  sl.registerFactory(() => UserBloc(getUserInfoUseCase: sl()));
  sl.registerFactory(() => LogoutBloc(repository: sl<LogoutRepositoryImpl>()));
  sl.registerFactory(() => AdminProductBloc(getProductsUseCase: sl(), addProductUseCase: sl(), updateProductUseCase: sl(), deleteProductUseCase: sl(),));
  ...
  sl.registerFactory(() => AdminProfileBloc(getAdminProfileUseCase: sl(), adminUpdateInfoUseCase: sl(),));

  sl.registerLazySingleton<StatisticRepository>(() => StatisticRepositoryImpl(orderClient: sl<OrderClient>()));
