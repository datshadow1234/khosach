...
class _$CartItemModelImpl implements _CartItemModel {
  ...
  @override
  String toString() {
    return 'CartItemModel(id: $id, productId: $productId, title: $title, quantity: $quantity, price: $price, imageUrl: $imageUrl, category: $category, author: $author, language: $language, country: $country, bookLink: $bookLink)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, productId, title, quantity,
      price, imageUrl, category, author, language, country, bookLink);
...
abstract class _CartItemModel implements CartItemModel {
  const factory _CartItemModel(
      ...
      final String bookLink}) = _$CartItemModelImpl;
