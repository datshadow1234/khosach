...
class _$AdminModelImpl extends _AdminModel {
  ...
  @override
  String toString() {
    return 'AdminModel(uid: $uid, email: $email, name: $name, phone: $phone, address: $address, role: $role, lastLogin: $lastLogin)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, uid, email, name, phone, address, role, lastLogin);
...
abstract class _AdminModel extends AdminModel {
  const factory _AdminModel(
      ...
      final String address,
      final String role,
      final String lastLogin}) = _$AdminModelImpl;
